...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: _objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_3__["mapState"])(['models', 'fetchingModels', 'modelBeingEdited'])),
  watch: {
    modelBeingEdited: function modelBeingEdited(model) {
      if (!model) return;
      var typeMap = {};
      _DbFieldTypes__WEBPACK_IMPORTED_MODULE_1__["default"].forEach(function (_ref) {
  ...
  methods: {
    populate: function populate() {
      axios.get("model/".concat(this.name, "/populate")).then(function (_ref2) {
        var data = _ref2.data;
        return console.log("Populate res: ", data);
      })["catch"](function (error) {
        return console.log("Populate error: ", error);
      });
    }
  },
  components: {
