    ...
    <div id="bcImageWrapper">
        <label>
            ...
            <div v-if="src === null && youtubeApiKey">
                <button type="button" :class="{'active' : source === 0}"
                    @click="source = 0">
                    <svg viewBox="0 0 24 24"><path d="M3.9 12c0-1.71 1.39-3.1 3.1-3.1h4V7H7c-2.76 0-5 2.24-5 5s2.24 5 5 5h4v-1.9H7c-1.71 0-3.1-1.39-3.1-3.1zM8 13h8v-2H8v2zm9-6h-4v1.9h4c1.71 0 3.1 1.39 3.1 3.1s-1.39 3.1-3.1 3.1h-4V17h4c2.76 0 5-2.24 5-5s-2.24-5-5-5z"/></svg>
                    Link
                </button>

                <button type="button" v-if="youtubeApiKey && youtubeApiKey.length" :class="{'active' : source === 1}"
                    @click="source = 1">
        ...
        <div v-if="src === null">
            <div id="linkInputWrapper" :class="{'typing': !src && enteringLink}" v-if="source === 0">
                ...
                @keyup.exact="enteringLink = $event.target.value.length > 0">

                <button type="button" :class="{'clickable' : !enteringLink && clipboardText != null}"
